...
public class DefaultGallostoreService implements GallostoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGallostoreService.class);
	...
	{
		return DefaultGallostoreService.class.getResourceAsStream("/gallostore/sap-hybris-platform.png");
	}
