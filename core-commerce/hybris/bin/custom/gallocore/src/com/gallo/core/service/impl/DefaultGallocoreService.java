...
public class DefaultGallocoreService implements GallocoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGallocoreService.class);
	...
	{
		return DefaultGallocoreService.class.getResourceAsStream("/gallocore/sap-hybris-platform.png");
	}
